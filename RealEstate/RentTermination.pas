...
type
  TRentTerminationF = class(TBaseFormF)
    ...
    lookUNITContractID: TIntegerField;
    lookUNITName: TWideStringField;
    lookUNITEstNo: TIntegerField;
    lookUNITunitNo: TIntegerField;
    lookUNITUnit: TWideStringField;
    lookUNITFloor: TWideStringField;
    lookUNITownerID: TIntegerField;
    SMSqryID: TIntegerField;
    SMSqryName: TWideStringField;
    SMSqryphone1: TWideStringField;
    NEamt: TUniNumberEdit;
    PaidAMTQ: TUniQuery;
...
var contValue , costPerDay ,daysCost ,paidAMT: Double;
...
PaidAMTQ.Close;
PaidAMTQ.SQL.Clear;
PaidAMTQ.SQL.Text := 'SELECT Sum(PaymentValu) as PaidAMT From Payments where  ContractNo = '''+ dbeContract.Text +'''  and Paid = TRUE';
PaidAMTQ.Open;



paidAMT := PaidAMTQ.FieldByName('PaidAMT').AsFloat;
...
//
 ...
 NEamt.Value :=  StrToFloat(dbeRentAMT.Text) - NEdifCost.Value - paidAMT;
...
//     TempQry.SQL.Clear;
     ...
     tSQL.Execute;
        ...
        PmtVal := StrToFloat(dbeRentAMT.Text) - NEdifCost.Value -  NEamt.Value;
