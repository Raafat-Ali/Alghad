...
uses
  ...
  uniListBox, uniLabel, uniGroupBox, frxClass, frxDBSet;
...
procedure TRcontractsF.frxReport1BeforePrint(Sender: TfrxReportComponent);
begin
  inherited;
...
begin
 ...
 PrintContractQ.Close;

 PrintContractQ.ParamByName('ConID').AsString := edtEmpNO.Text;
